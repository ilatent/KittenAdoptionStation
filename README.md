# Kitten Adoption Station

<!--- Replace <OWNER> with your Github Username and <REPOSITORY> with the name of your repository. -->
<!--- You can find both of these in the url bar when you open your repository in github. -->
![Workflow result](https://github.com/ilatent/KittenAdoptionStation/workflows/Check/badge.svg)
...
The application includes an overview screen that shows a list of kittens, and a detail screen that shows details about each kitten.
